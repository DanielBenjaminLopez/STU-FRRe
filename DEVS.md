...
El cumplimiento de estas reglas es estricto y obligatorio. Este repositorio está conectado directamente al tablero de Jira. Cualquier desviación en la nomenclatura de ramas o commits romperá la trazabilidad del código y las automatizaciones, ocultando el trabajo real del equipo.
...
* **Sintaxis estricta:** Solo minúsculas, números y guiones medios. Cero espacios, cero tildes, cero eñes, cero caracteres especiales.
...
* **Regla técnica:** El inicio del mensaje debe ser exactamente la clave de Jira en mayúsculas, seguida de dos puntos y un espacio.

**Ejemplos**

* Correcto: `SCRUM-30: agregar instructivo de integracion con jira al readme`
...
El código fusionado en `develop` y marcado como "Listo para Lanzamiento" en Jira se encuentra en un entorno de preparación. No está en producción.

Los despliegues a producción se realizan exclusivamente los días lunes mediante un Pull Request desde `develop` hacia `main`. Únicamente después de confirmar que el despliegue fue exitoso y el servidor es estable, el líder técnico moverá manualmente las tarjetas desde "Listo para Lanzamiento" hacia **Finalizado** en el tablero de Jira, cerrando oficialmente el ciclo de la tarea.
